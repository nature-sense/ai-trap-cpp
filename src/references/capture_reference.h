...
namespace io::naturesense {
    ...
    public:
        ...
        [[nodiscard]] ImageReference get_hi_res_image() const;
        [[nodiscard]] ImageReference get_lo_res_image() const;
        [[nodiscard]] std::vector<DetectionReference> get_detections() const;
        void add_detection(DetectionReference detection);
